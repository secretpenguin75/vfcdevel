...
def superplot(MODELDATA,OBSDATA, NAMECORE, NOISESCALE_MM=10, MIXINGSCALE_MM=40):
    ...
    plt.step(OBSDATA['d18O'],-OBSDATA['Depth(m)'], where = 'mid', color=c_core, label=label_core, linewidth=4)
    plt.step(VFC_nl_ml['d18O no diff'],-VFC_nl_ml['Depth(m)'], where = 'mid', color=c_VFC_no_diff, linewidth=4)
    plt.step(VFC_nl_ml['d18O diff'],-VFC_nl_ml['Depth(m)'], where = 'mid', color=c_VFC_diff, linewidth=4)
